...
public class Main {
    public static <Ollama> void main(String[] args) throws OllamaException {
        Ollama ollama;
        ...
        OllamaChatRequest requestModel = builder.withMessage(OllamaChatMessageRole.USER, "What is the capital of England?").build();
